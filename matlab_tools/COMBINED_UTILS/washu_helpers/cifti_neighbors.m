...
% SSRDE edit - DVD Dec 2021 - down with hardcoding!!
surfneighborfile = [fileparts(which('cifti_neighbors.m')) filesep 'node_neighbors.txt']
disp(surfneighborfile)
